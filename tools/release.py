...
def write_manifest(version_tag, asset_name, sha256, notes_summary, output_path):
...
def cmd_write_manifest(args):
    ...
    write_manifest(args.version_tag, args.asset_name, args.sha256, notes_summary, args.output)
